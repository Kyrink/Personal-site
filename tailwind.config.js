...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      keyframes: {
        animateCircle: {
          "0%": {
            transform:
              "perspective(1000px) rotateY(0deg) rotateX(15deg) translateY(-30px)",
          },
          "100%": {
            transform:
              "perspective(1000px) rotateY(360deg) rotateX(15deg) translateY(-30px)",
          },
        },
        distortAndGrow: {
    ...
    fontSize: {
      ...
      "4xl": "23px",
      "3xl": "21px",
      "2xlx": "45px", // New custom font size
      "3xlx": "60px",
      inherit: "inherit",
    },
  },

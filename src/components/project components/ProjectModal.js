...
const ProjectModal = ({
  ...
  return (
    <div className=" absolute w-full h-full top-0 left-0 z-50 bg-black  shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] box-border overflow-auto flex flex-col items-center justify-center px-[5%] pb-[5%] pt-[2%] gap-[30px] tracking-[normal] border-[1px] border-solid border-dimgray ">
      ...
      <section className="flex flex-row items-end justify-center gap-[30px] max-w-full text-center text-sm text-white font-rhapsody mq900:flex-wrap">
        <div className="w-11 flex flex-col items-start justify-start gap-[15px]">
          <a
            ...
            className="self-stretch flex flex-col items-start justify-center pt-0 px-0 pb-2"
          >
            <div
              className="group hover:animate-distortAndGrow icon-hover-group hover:text-orange"
              style={{ "--icon-hover-color": "var(--icon-hover)" }}
            >
              <span>
                <FaLink
                  size="40"
                  className=" icon-color text-icon-default group-hover:text-icon-hover"
                />
              </span>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-[42.1px] flex flex-col items-center justify-start"
          >
            <div
              className="group hover:animate-distortAndGrow icon-hover-group hover:text-orange"
              style={{ "--icon-hover-color": "var(--icon-hover)" }}

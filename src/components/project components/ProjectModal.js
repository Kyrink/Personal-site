...
const ProjectModal = ({ projectName, projectDescription, demoLink, codeLink, imageUrls, closeModal }) => {
  return (
    <div className="w-full relative bg-gray shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] box-border overflow-hidden flex flex-col items-center justify-center p-[5%] gap-[30px] tracking-[normal] border-[1px] border-solid border-dimgray mq450:pl-5 mq450:box-border mq700:gap-[15px_30px] mq700:pl-[83px] mq700:box-border">
      <div className='self-stretch flex flex-col items-end justify-end'>
        <FaTimes size="40px" />
      </div>
      <div className="self-stretch flex flex-row items-center justify-center font-rhapsody text-lgx">
